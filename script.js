...
function save10() {
    ...
    saveBtn10.addEventListener("click", save10);
...
function save11() {
    ...
    saveBtn11.addEventListener("click", save11);
...
function save12() {
    ...
    saveBtn12.addEventListener("click", save12);
...
function save13() {
    ...
    saveBtn13.addEventListener("click", save13);
...
function save14() {
    ...
    saveBtn14.addEventListener("click", save14);
...
function save15() {
    ...
    saveBtn15.addEventListener("click", save15);
